                    ...
                    user
                        ? <div className='flex items-center gap-2 sm:gap-3'>
                            <button 
                                ...
                                className='relative flex items-center gap-2 bg-blue-100 px-4 sm:px-6 py-1.5 sm:py-3 rounded-full hover:scale-105 transition-all duration-700 
                                           border-2 border-transparent animate-glow'
                            >
                                <span className='absolute inset-0 border-2 border-blue-400 rounded-full opacity-75 blur-md animate-glow'></span>
